...
public class Castle extends Gamemode {
    ...
    public class Impl extends Gamemode.Impl {
        ...
        public Castle.Impl block(Block value) {
            ...
            try (TagWrite write = TagWrite.of(rules())) { write.w(TURRET, value); }
            return this;
        }
        ...
        public Castle.Impl blockCost(int value) {
            blockCost = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(TURRET+block+COST, value); }
            return this;
        }
        ...
        public Castle.Impl unit(UnitType value) {
            ...
            try (TagWrite write = TagWrite.of(rules())) { write.w(UNIT, value); }
            return this;
        }
        ...
        public Castle.Impl unitCost(int value) {
            unitCost = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(UNIT+unit+COST, value); }
            return this;
        }
        ...
        public Castle.Impl unitIncome(int value) {
            unitIncome = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(UNIT+unit+INCOME, value); }
            return this;
        }
        ...
        public Castle.Impl unitDrop(int value) {
            unitDrop = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(UNIT+unit+DROP, value); }
            return this;
        }
        ...
        public Castle.Impl item(Item value) {
            ...
            try (TagWrite write = TagWrite.of(rules())) { write.w(ITEM, value); }
            try (TagRead read = TagRead.of(rules())) {
            Log.info("@ @",value,read.r(ITEM,Items.copper));
            }
            return this;
        }
        ...
        public Castle.Impl itemCost(int value) {
            itemCost = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(ITEM+item+COST, value); }
            return this;
        }
        ...
        public Castle.Impl itemInetrval(int value) {
            itemInetrval = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(ITEM+item+INTERVAL, value); }
            return this;
        }
        ...
        public Castle.Impl itemAmount(int value) {
            itemAmount = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(ITEM+item+AMOUNT, value); }
            return this;
        }
        private Block drill;
        ...
        public Castle.Impl drill(Block value) {
            drill = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(ITEM+item+DRILL, value); }
            return this;
        }
        ...
        public Castle.Impl status(StatusEffect value) {
            ...
            try (TagWrite write = TagWrite.of(rules())) { write.w(STATUS, value); }
            return this;
        }
        ...
        public Castle.Impl statusDelay(int value) {
            statusDelay = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(STATUS+status+DELAY, value); }
            return this;
        }
        ...
        public Castle.Impl statusCost(int value) {
            statusCost = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(STATUS+status+COST, value); }
            return this;
        }
        ...
        public Castle.Impl statusDuration(int value) {
            ...
            try (TagWrite write = TagWrite.of(rules())) { write.w(STATUS+status+DURATION, value); }
            return this;
        }
        ...
        public Castle.Impl statusAlly(boolean value) {
            statusAlly = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(STATUS+status+ALLY, value); }
            return this;
        }
        ...
        public Castle.Impl groundSpawn(String value) {
            groundSpawn = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(UTILS+"groundSpawn", value); }
            return this;
        }
        ...
        public Castle.Impl airSpawn(String value) {
            airSpawn = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(UTILS+"airSpawn", value); }
            return this;
        }
        ...
        public Castle.Impl navalSpawn(String value) {
            navalSpawn = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(UTILS+"navalSpawn", value); }
            return this;
        }
        ...
        public Castle.Impl defenseUnitCap(int value) {
            ...
            try (TagWrite write = TagWrite.of(rules())) { write.w(UTILS+"defenseUnitCap", value); }
            return this;
        }
        ...
        public Castle.Impl attackUnitCap(int value) {
            attackUnitCap = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(UTILS+"attackUnitCap", value); }
            return this;
        }
        ...
        public Castle.Impl divideCap(boolean value) {
            divideCap = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(UTILS+"divideCap", value); }
            return this;
        }
        ...
        public Castle.Impl bettergroundvalid(boolean value) {
            ...
            try (TagWrite write = TagWrite.of(rules())) { write.w(UTILS+"bettergroundvalid", value); }
            return this;
        }
        ...
        public Castle.Impl noplatform(boolean value) {
            noplatform = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(UTILS+"noplatform", value); }
            return this;
        }
        ...
        public Castle.Impl shopFloor(Block value) {
            shopFloor = value;
            try (TagWrite write = TagWrite.of(rules())) { write.w(UTILS+"shopFloor", value); }
            return this;
        }
        ...
        public Castle.Impl platformSource(String value) {
            ...
            try (TagWrite write = TagWrite.of(rules())) { write.w(UTILS+"platformSource", value); }
            return this;
        }
    }
}
